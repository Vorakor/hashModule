	...
	if (distRend == True):
			...
			if (multiSpecs == True):
				for name in filename:
					...
					while printbool == True:		
						...
						create.main(hash[0], False, path[0], name, ext[0], alg[0], None, None, None, None, spec, printbool)
		...
		if (specification == None):
			...
			if (multiSpecs == True):
					...
					if (location == None):
						...
						if (altloc == True):
							...
							try:
								...
								create.main(hash[count], False, path[count], name, ext[count], alg[count], None, None, None, None, spec, printbool, loc)
								print "\nYour file has been created and saved to: " + loc
						else:
							create.main(hash[count], False, path[count], name, ext[count], alg[count], None, None, None, None, spec, printbool)
							print "\nYour file has been created and saved to: " + path[count]
					elif (location == 'path'):
						create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, printbool)
				...
				while printbool == True:		
					print "\nSpecifier chosen: " + spec
					create.main(hash[0], False, path[0], filename[0], ext[0], alg[0], None, None, None, None, spec, printbool)
					newmsg = "Is this the format you would like to use?"
					loopbool = yOrN(newmsg)
					if (loopbool == True):
						printbool = False
				...
				if (location == None):
					...
					if (altloc == True):
						...
						try:
							...
							create.main(hash, True, path, filename, ext, alg, None, None, None, None, spec, printbool, loc)
							print "\nYour files have been created and saved to: " + loc
					else:
						create.main(hash, True, path, filename, ext, alg, None, None, None, None, spec, printbool)
			...
			if (location == None):
				...
				if (altloc == True):
					...
					try:
						...
						create.main(hash, True, path, filename, ext, alg, None, None, None, None, spec, False, loc)
						print "\nYour files have been created and saved to: " + loc
				else:
					create.main(hash, True, path, filename, ext, alg, None, None, None, None, spec, False)
					print "\nYour files have been created and saved to: " + path[0]
			elif (location == 'path'):
				create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, False)
				print "\nYour file has been created and saved to: " + path
			else:
				loc = location
				create.main(hash, True, path, filename, ext, alg, None, None, None, None, spec, False, loc)
	...
	if (location == None):
		...
		if (altloc == True):
			...
			try:
				...
				create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, printbool, loc)
				print "\nYour file has been created and saved to: " + loc
		else:
			create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, printbool)
			print "\nYour file has been created and saved to: " + path
...
def singleNoPrompts( file, algorithm=None, specification=None, location=None, distRend=False ):
	...
	if (location == None):
		loc = None
		create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, False, loc)
	else:
		loc = location[0]
		loc = loc.rstrip()
		create.main(hash, False, path, filename, ext, alg, None, None, None, None, spec, False, loc)
